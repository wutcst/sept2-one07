...
public class ControlsPanel extends JPanel implements ActionListener
{
	...
	private JButton buttonGive = new JButton("赠与");
	private JButton buttonBack = new JButton("返回上一步");
	private JButton buttonNorth = new JButton("北");
	private JButton buttonInventory = new JButton("背包");
	private JButton buttonWest = new JButton("西");
	private JButton buttonSouth = new JButton("南");
	private JButton buttonEast = new JButton("东");
	...
	public void drawControlsTable()
	{
		...
		// 		设置北向按钮
		this.buttonNorth.setPreferredSize(new Dimension(50, 60));
        ...
        // 		设置西向按钮
        this.buttonWest.setPreferredSize(new Dimension(80, 100));
        ...
        // 		添加东向按钮
        this.buttonEast.setPreferredSize(new Dimension(80, 100));
